...
class Toplevel1:
    def __init__(self, top=None):
        ...
        for num, item in enumerate(items):
            if item == "DUMMY":
                continue
            self.Scrolledtreeview2.insert("", "end", str(num + 1), text=f"{num + 1:03} - {item}")
        ...
        for num, challenge in enumerate(challenges):
            self.Scrolledtreeview3.insert("", "end", str(num + 1), text=f"{num + 1} - {challenge}")
